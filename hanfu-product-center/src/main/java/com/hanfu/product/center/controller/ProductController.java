...
public class ProductController {
	...
	@ApiOperation(value = "通过类目名称查询类目", notes = "通过类目名称查询类目")
	@RequestMapping(value = "/findCategroyByName", method = RequestMethod.GET)
	public ResponseEntity<JSONObject> findCategroyByName(String name) throws Exception {
		BodyBuilder builder = ResponseUtils.getBodyBuilder(HttpStatus.OK);
		return builder.body(ResponseUtils.getResponseBody(productDao.selectFindCategroyByName(name)));
	}
}
