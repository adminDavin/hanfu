...
public class HfGoodsDisplay extends CommonRequest {
	...
	public String toString() {
		return "HfGoodsDisplay [id=" + id + ", goodName=" + goodName + ", warehouseName=" + warehouseName
				+ ", productCategoryName=" + productCategoryName + ", goodsDesc=" + goodsDesc + ", categoryId="
				+ categoryId + ", quantity=" + quantity + ", sellPrice=" + sellPrice + ", specValue=" + specValue
				+ ", productSpecId=" + productSpecId + ", priceId=" + priceId + ", respId=" + respId + ", productId="
				+ productId + ", fileId=" + fileId + ", username=" + username + ", stoneId=" + stoneId + ", cancelId="
				+ cancelId + ", claim=" + claim + ", frames=" + frames + ", brandName=" + brandName + ", prictureDesc="
				+ prictureDesc + ", memeber=" + memeber + ", sellPrice1=" + sellPrice1 + ", sellPrice2=" + sellPrice2
				+ ", evaluate=" + evaluate + ", hfValue=" + hfValue + ", productName=" + productName
				+ ", productSpecName=" + productSpecName + ", createTime=" + createTime + ", modifyTime=" + modifyTime
				+ ", isDeleted=" + isDeleted + "]";
	}
