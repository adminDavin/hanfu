...
public class Message {
    ...
    static final String accessKeyId = "LTAI4GGEyuRP7x3fSTKLa6mk";  // TODO 修改成自己的
    static final String accessKeySecret = "cQfnzkae2zBBU7Th6vH47FN14OuAnM";   // TODO 修改成自己的
    ...
    public static Integer sendSms(String telephone) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("思维创造");    // TODO 修改成自己的
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_190910735");    // TODO 修改成自己的
